...
public class GameScores extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run(){
                GameMainWindow gMW_JF = new GameMainWindow();
                gMW_JF.setVisible(true);

                GameScores.this.setVisible(false);
                GameScores.this.dispose();
            }
        });
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GameScores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
